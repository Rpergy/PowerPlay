...
class FieldConstants {
    object LeftBlueAutonomous {
        ...
        val cyclePosition2 = Pose2d(37.4, 6.0, Math.toRadians(-164.5))
    ...
    object LeftRedAutonomous {
        ...
        val parkPosition2 = Pose2d(-41.0, -15.0, Math.toRadians(90.0))
    ...
    object RightBlueAutonomous {
        ...
        val parkingTransition = Pose2d(-38.0, 14.0, Math.toRadians(-90.0))
        val parkPosition1 = Pose2d(-15.0, 15.0, Math.toRadians(-90.0))
        val parkPosition2 = Pose2d(-37.0, 15.0, Math.toRadians(-90.0))
    ...
    object RightRedAutonomous {
        val startPosition = Pose2d(38.0, -64.0, Math.toRadians(90.0))
        val cyclePosition1 = Vector2d(38.0, -20.0)
        val cyclePosition2 = Pose2d(38.0, -5.0, Math.toRadians(163.0))
    ...
    object LeftBlueDumpling {
        val cyclePosition = Pose2d(36.0, 23.0, Math.toRadians(-193.0))
    }

    object LeftRedDumpling {
        val cyclePosition = Pose2d(-36.0, -23.0, Math.toRadians(-16.0))
    }
    object RightBlueDumpling {
        val cyclePosition = Pose2d(-36.0, 22.0, Math.toRadians(14.0))
    }

    object RightRedDumpling {
        val cyclePosition = Pose2d(35.5, -22.0, Math.toRadians(194.0))
    }
}